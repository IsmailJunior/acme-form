...
<template>
	<Html :lang="htmlAttrs.lang" :dir="htmlAttrs.dir">
		<div
			:class="[
				'bg-[#005479] text-white flex gap-4 items-center flex-row-reverse p-4',
				{ 'bg-[#181818]': $colorMode.value === 'dark' },
			]"
		>
			<div
				:class="[
					'bg-[#005479] text-white flex gap-4 flex-row-reverse',
					{ 'bg-[#181818]': $colorMode.value === 'dark' },
				]"
			>
